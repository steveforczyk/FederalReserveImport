function [PStats]=SpecifyMatlabConfigurationRev2(CodeFileName,PStats,fid)
% This function will specify the current matlab code configuration
% Will use a class object
% Written By: Stepthen Forczyk
% Created: May 7,2025
% Revised: removed globals by creating a class object
...
% Add to Object
PStats.FileNameInventory=FileNameInventory;
PStats.AvailToolBoxList=AvailToolBoxList;
PStats.ReqToolBoxList=ReqToolBoxList;
PStats.totalLOC=totalLOC;
PStats.ComputerMemoryList=ComputerMemoryList;
PStats.ComputerMemoryTable=ComputerMemoryTable;
PStats.flist=flist;
PStats.plist=plist;
PStats.AT1=AT1;
PStats.AT2=AT2;
PStats.AvailToolBoxTable1=AvailToolBoxTable1;
PStats.AvailToolBoxTable2=AvailToolBoxTable2;
nowt = datetime('now','TimeZone','local','Format','d-MMM-y HH:mm:ss Z');
PStats.nowt=nowt;
ab=1;
end
