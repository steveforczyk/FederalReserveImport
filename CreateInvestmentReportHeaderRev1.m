function CreateInvestmentReportHeaderRev1
% This function will create the initial "boilerplate" header info
% for the stock investment report header
% Written By: Stephen Forczyk
% Created: Feb 1-,2025
% Revised: Mar 9,2025  changed to Rev 1 because this verion is flawed
% Will revert to the original version until bug found
...
% Create Chapter 1 with general program information
    ...
    % graphic
    parastr31='In this example the symbol for XOM or Exon Mobil was inserted to the search box';
...
% Show Historical XOM stock data
    ...
    [nhigh,nwid,~]=size(imdata);
    image = mlreportgen.report.FormalImage();
    image.Image = which('XOMHistoricalRev1Data.jpg');
    ...
    % Now display the opening page of the add a paragraph to explain the
    % graphic
    parastr41='The graphic below shows a tilen slice of XOM vlosing prices over the Jan 1990 to Dec 2024';
